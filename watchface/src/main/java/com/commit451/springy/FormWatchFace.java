...
import com.commit451.springy.common.FormClockRenderer;
...
import static com.commit451.springy.common.FormClockRenderer.ClockPaints;
import static com.commit451.springy.common.MathUtil.constrain;
import static com.commit451.springy.common.MathUtil.decelerate3;
import static com.commit451.springy.common.MathUtil.interpolate;
    ...
    private class Engine extends CanvasWatchFaceService.Engine {
        ...
        private void updatePaintsForTheme(Theme theme) {
            if (theme == MUZEI_THEME) {
                ...
                mNormalPaints.fills[0].setColor(getResources().getColor(theme.color));
                mNormalPaints.fills[1].setColor(getResources().getColor(theme.color));
                mNormalPaints.fills[2].setColor(Color.WHITE);
                mNormalPaints.date.setColor(getResources().getColor(theme.color));
